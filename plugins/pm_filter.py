...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝗘𝗑𝗍𝗋𝖺', callback_data='extra'),
            ...
            InlineKeyboardButton('𝗡𝖾𝗑𝗍⇉.', callback_data='help')           
        ]] 
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝗨𝗋𝗅-𝗦𝗁𝗈𝗋𝗍', callback_data='urlshort'),
            ...
            InlineKeyboardButton('𝗗𝖾𝗉𝗅𝗈𝗒', callback_data='suneesh'),
        ...
        buttons= [[
            InlineKeyboardButton('🏠𝗛𝗈𝗆𝖾', callback_data='start'),
            InlineKeyboardButton('𝗖𝗅𝗈𝗌𝖾✘', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('.⇇𝗕𝖺𝖼𝗄', callback_data='help2'),
            InlineKeyboardButton('𝗥𝖾𝖿𝗋𝖾𝗌𝗁♻️', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('.⇇𝗕𝖺𝖼𝗄', callback_data='help2'),
            InlineKeyboardButton('𝗕𝗎𝗍𝗍𝗈𝗇𝗌⚜️', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('.⇇𝗕𝖺𝖼𝗄', callback_data='manuelfilter2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝗚𝗅𝗈𝖻𝖺𝗅 𝗙𝗂𝗅𝗍𝖾𝗋', callback_data='gfill'),
            InlineKeyboardButton('𝗨𝗌𝖾𝗋 & 𝗖𝗁𝖺𝗍', callback_data='uschat')
            ],[
            InlineKeyboardButton('.⇇𝗕𝖺𝖼𝗄', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[            
            InlineKeyboardButton('.⇇𝗕𝖺𝖼𝗄', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        ...
        if settings is not None:
            buttons = [
                [
                    InlineKeyboardButton('𝗙𝗂𝗅𝗍𝖾𝗋 𝗕𝗎𝗍𝗍𝗈𝗇',
                                         callback_data=f'setgs#button#{settings["button"]}#{str(grp_id)}'),
                    InlineKeyboardButton('𝗦𝗂𝗇𝗀𝗅𝖾' if settings["button"] else '𝗗𝗈𝗎𝖻𝗅𝖾',
                                         callback_data=f'setgs#button#{settings["button"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝗙𝗂𝗅𝖾 𝗠𝗈𝖽𝖾', callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}'),
                    InlineKeyboardButton('𝗖𝗁𝖺𝗇𝗇𝖾𝗅' if settings["botpm"] else '𝗦𝗍𝖺𝗋𝗍',
                                         callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝗙𝗂𝗅𝖾 𝗦𝖾𝖼𝗎𝗋𝖾',
                                         callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["file_secure"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾',
                                         callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝗜𝗆𝖽𝖻 𝗣𝗈𝗌𝗍𝖾𝗋', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["imdb"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾',
                                         callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝗦𝗉𝖾𝗅𝗅 𝗖𝗁𝖾𝖼𝗄',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["spell_check"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝗪𝖾𝗅𝖼𝗈𝗆𝖾 𝗠𝗌𝗀', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["welcome"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾',
